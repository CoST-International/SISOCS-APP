...
class SubsectorController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Subsector']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->idSubSector));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Subsector');
	...
	//$records=Subsector::model()->findAll();
		//$this->render('admin',array(
			//'records'=>$records,
		//));
	}
	 ...
	 * @param Subsector $model the model to be validated
	 */
