...
class ProyectoFuenteController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','Create2','BatchUpdate','Addfuente','DeleteProyectoFuente','delete'),
				'users'=>array('@'),
			),
	...
	public function actionUpdate($idProyecto, $idFuente)
	{

			$model=$this->loadModel(array('idProyecto'=>$idProyecto,'idFuente'=>$idFuente));
	 ...
	 */
	public function actionDelete($idProyecto, $idFuente)
	{
		$this->loadModel(array('idProyecto'=>$idProyecto,'idFuente'=>$idFuente))->delete();
		try {
            Yii::app()->Controller->saveMongo($model->idProyecto);
        } catch (Exception $e) {
	...
	public function actionDeleteProyectoFuente($idProyecto, $idFuente)
	{
			try {
					$command = Yii::app()->db->createCommand();
					$pro = $command->delete('cs_proyecto_fuente', 'idProyecto=:idProyecto and idFuente=:idFuente', array(
							':idProyecto' => $_GET['idProyecto'],
							':idFuente' => $_GET['idFuente']
					));
					//$this->actionUpdate($_GET['idFuente']);
					$this->redirect(array('proyecto/update','id'=>$_GET['idProyecto']));
			}
