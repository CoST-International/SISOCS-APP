...
class TransactionsController extends Controller
{
	...
	public function actionCreate($id)
	{
		...
		if(isset($_POST['Transactions']))
		{
			...
			$payerName=Yii::app()->db->createCommand("SELECT legalName FROM cs_parties WHERE id=".$model->payer_id)->queryScalar();
			$model->payer_name=$payerName;
			$payeeName=Yii::app()->db->createCommand("SELECT legalName FROM cs_parties WHERE id=".$model->payee_id)->queryScalar();
