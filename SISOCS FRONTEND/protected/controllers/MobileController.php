...
class MobileController extends Controller
{
    public function accessRules()
    {
        return array(
            ...
            array('allow',  // allow all users to perform 'index' and 'view' actions
                'actions'=>array('BPrograma','update','fichatecnicapro','fichatecnicaprg','fichatecnicacon','Informecumplimiento','BCumplimiento','PreFichaTecnicaM'),
                'users'=>array('@'),
            ),
            array('allow',  // allow all users to perform 'index' and 'view' actions
    ...
    public function actionresumendeejecucion($IdPrograma,$IdProyecto,$IdContratacion)
    {
        $this->layout='column3';
        $this->render('resumendeejecucion',array('IdPrograma'=>$IdPrograma,'IdProyecto'=>$IdProyecto,'IdContratacion'=>$IdContratacion));
    }

    public function actionresumendeejecucion2($IdPrograma,$IdProyecto,$IdContratacion)
    {
        $this->render('resumendeejecucion2',array('IdPrograma'=>$IdPrograma,'IdProyecto'=>$IdProyecto,'IdContratacion'=>$IdContratacion));
    }

    public function actionresumendeejecucion3($IdPrograma,$IdProyecto,$IdContratacion)
    {
        $this->render('resumendeejecucion3',array('IdPrograma'=>$IdPrograma,'IdProyecto'=>$IdProyecto,'IdContratacion'=>$IdContratacion));
    }
...
//     public function actionresumendeejecucion($IdPrograma,$IdProyecto)
//    {
//        $this->render('resumendeejecucion',array('IdPrograma'=>$IdPrograma,'IdProyecto'=>$IdProyecto));
//    }
    ...
    public function actionMob_Ciudadano()
    {
        $this->layout='column3';
         $this->render('mob_ciudadano');

        // $this->render('pages/about');
    }

     public function actionCiudadano()
    {
        $this->layout='column3';
        $this->render('ciudadano');
    }


       public function actionBProyecto2()
    {
        ...
        $sql=    "Select DISTINCT
                ...
                From
                  vCiudadano
                Where
                  (vCiudadano.idContratacion is not null)
                  And
                  (
                   ...
                   )   And (vCiudadano.contratacion_estado='PUBLICADO')
                ";
        ...
        $sql=    "Select DISTINCT
                ...
                From
                  vCiudadano
                Where
                  (vCiudadano.idAdjudicacion IS NOT NULL And vCiudadano.idContratacion IS NULL)
                   And
                  (
                      (vCiudadano.programa_codigo Like '%$criterio%') Or
                      (vCiudadano.programa_nombre Like '%$criterio%') Or
                      ...
                      (vCiudadano.contratacion_numero Like '%$criterio%') Or
                      (vCiudadano.contratacion_alcances Like '%$criterio%')
                   ) And (vCiudadano.adjudicacion_estado='PUBLICADO')
                ";
        ...
        $sql=    "Select DISTINCT
                ...
                Where
                  ...
                  (
                      ...
                      (vCiudadano.contratacion_numero Like '%$criterio%') Or
                      (vCiudadano.contratacion_alcances Like '%$criterio%')
                   )  And (vCiudadano.calificacion_estado='PUBLICADO')
                ";
                ...
                Where
                  (vCiudadano.idProyecto is not null And vCiudadano.idCalificacion is null) And
                   (
                      ...
                      (vCiudadano.contratacion_numero Like '%$criterio%') Or
                      (vCiudadano.contratacion_alcances Like '%$criterio%')
                    )  And (vCiudadano.proyecto_estado='PUBLICADO')
                ";
        ...
        $sql=    "Select DISTINCT
                ...
                Where
                  ...
                  (
                      ...
                      (vCiudadano.contratacion_numero Like '%$criterio%') Or
                      (vCiudadano.contratacion_alcances Like '%$criterio%')
                   ) And (vCiudadano.programa_estado='PUBLICADO')
                ";
    ...
    // *********************** Lista de Proyectos
        $sql= " Select distinct idProyecto,
                ...
                From
                  vCiudadano
                Where
                  (proyecto_iddepartamento = '$criterio')";
    ...
    public function actionPreFichaTecnicaM($id) {
        $proyecto = array();
        $adquisicion = array();
        ...
        $proyecto=Yii::app()->db->createCommand($sql)->queryAll();
        ...
        $this->render('PreFichaTecnicaM',array(
                        'proyecto'=>$proyecto,
    ...
    public function actionFichaTecnica2($control, $id)
    {
...
//    public function actionUpdateAjax_Carrousel($data)
//    {
//        $data = array();
//        $data["IdAvance"] =  $data;
//
...
//        public function actionGeneratePdf_ResumendeEjecucion()
//	{
//
//		//Yii::import('application.modules.admin.extensions.giiplus.bootstrap.*');
//		//require_once('tcpdf/tcpdf.php');
...
//                 $model = Programa::model()->findAll();
//
//		$html = $this->renderPartial('resumendeejecucion_print', array(
//			'model'=>$model
//		), true);
//
//
//               // $html = $this->renderPartial('resumendeejecucion');
//
//		$pdf = Yii::createComponent('application.extensions.MPDF56.mpdf');
//		$pdf= new mPDF();
//        $pdf->WriteHTML($html);
//         $nom="ResumendeEjecucion_".date("d-m-Y").".pdf";
//        $url=Yii::app()->baseUrl . '/'.$nom;
//         //$url=Yii::app()->basePath."/images/".$nom;
//        $pdf->Output($nom,"F");
//        echo '<a href='.$url.'>Descargar Reporte </a>';
...
//        public function actionGeneratePdf_ResumendeEjecucion($idPrograma, $idProyecto)  {
//        $html = $this->render('resumendeejecucion',array('IdPrograma'=>$idPrograma,'IdProyecto'=>$idProyecto));
//        $pdf = Yii::createComponent('application.extensions.MPDF56.mpdf');
//        $pdf= new mPDF();
//        $pdf->WriteHTML($html);
//        $nom="ResumendeEjecucion_".date("d-m-Y").".pdf";
...
//
//
//        $html = $this->render('resumendeejecucion_print',array('IdPrograma'=>$idPrograma,'IdProyecto'=>$idProyecto));
//        $pdf = Yii::createComponent('application.extensions.MPDF56.mpdf');
//        $pdf= new mPDF();
//        $pdf->WriteHTML($html);
//        $nom="ResumendeEjecucion_".date("d-m-Y").".pdf";
