...
class FinanceController extends Controller
{
	...
	public function actionCreate($id)
	{
		...
		if(isset($_POST['Finance']))
		{
			...
			$model->financingParty_name=Yii::app()->db->createCommand("SELECT legalName FROM cs_parties WHERE id=".$model->financingParty_id)->queryScalar();
			$model->idContratacion=$id;
			if($model->save()){
				try {
