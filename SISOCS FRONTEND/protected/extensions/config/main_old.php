...
return array(
	...
	'name'=>'SISOCS',
        'theme'=>'abound',        //'theme'=>'blackboot',//'abound',//'bootstrap',//'mattskitchen',//'twitter_fluid',//'newssourcefinal',//'blackboot',//'freearch',
        'language'=>'es',
...
//		),
		...
		'db'=>array(
			/*'connectionString' => 'mysql:host=localhost;dbname=soptravidb2',
			'emulatePrepare' => true,
			'username' => 'root',
			'password' => '',
			'charset' => 'utf8',
                   */ 'connectionString' => 'mysql:host=localhost;dbname=soptravidb3',
                    'emulatePrepare' => true,
                    'username' => 'root',
                    'password' => 'root',
                    'charset' => 'utf8',
