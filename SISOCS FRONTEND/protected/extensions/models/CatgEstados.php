...
/**
 * This is the model class for table "{{catg_estados}}".
 *
 * The followings are the available columns in table '{{catg_estados}}':
 ...
 */
class CatgEstados extends CActiveRecord
{
	/**
	 ...
	 * @return CatgEstados the static model class
	 */
