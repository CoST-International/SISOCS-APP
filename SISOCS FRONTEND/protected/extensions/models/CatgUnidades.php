...
/**
 * This is the model class for table "{{catg_unidades}}".
 *
 * The followings are the available columns in table '{{catg_unidades}}':
 ...
 */
class CatgUnidades extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('codigo, descripcion, abreviatura, fecha_registro, user_registro', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return CatgUnidades the static model class
	 */
