...
//		);
 return array('accessControl',array('CrugeAccessControlFilter'));
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','ViewDetempresa','ViewDetoferentes2','ViewDetoferentes','ViewDetfirmas','DeleteGet','GeneratePdf','GenerateExcel','FuncionarioRespond','TraerAdquisicion'),
				'users'=>array('*'),
			),
	...
	public function ViewDetoferentes2(){
	...
	public function actionFuncionarioRespond($id) {
