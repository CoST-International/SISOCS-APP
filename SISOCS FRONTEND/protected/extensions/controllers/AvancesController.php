...
//		);
	...
	Yii::import('ext.EWideImage.*');
        ...
        if (isset($_POST['Avances'])) {
            ...
            $criteria->condition = 'codigo=:idCod';
		...
		$id = $model->codigo;
                ...
                //$dir=Yii::getPathOfAlias('webroot.adjuntos');
    ...
    public function actionAdmin2($id) {
        $variableSession=Yii::app()->getSession()->add('cod_inicioEjecucion',$id );
        $idSession=Yii::app()->getSession()->get('cod_inicioEjecucion');
		$Criteria = new CDbCriteria();
        $Criteria->condition = "codigo_inicio_ejecucion = $idSession";
