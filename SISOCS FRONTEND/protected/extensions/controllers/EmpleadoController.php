...
class EmpleadoController extends CController
{
	...
	public function actionIndex()
	{
                ...
                if(isset($_GET['Empleado']))
		{
                       ...
                       if (!empty($model->idempleado)) $criteria->addCondition('idempleado = "'.$model->idempleado.'"');
                       ...
                       if (!empty($model->archivo)) $criteria->addCondition('archivo = "'.$model->archivo.'"');
                     
                    			
		}
                 $session['Empleado_records']=Empleado::model()->findAll($criteria); 
        ...
        public function actionGeneratePdf() 
	{
		...
		$pdf->SetTitle('Empleado Report');
		$pdf->SetSubject('Empleado Report');
