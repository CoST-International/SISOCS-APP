...
//	}
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['ImgAdjuntadas'])) 
		{
			...
			$ruta_de_guardado = YiiBase::getPathOfAlias("images.img_subidas");
			...
			if (@!empty($_FILES['ImgAdjuntadas']['name']['nombre_img'])) {
			    $model3->nombre_img = $_POST['ImgAdjuntadas']['nombre_img'];
			    $model3->nombre_img = CUploadedFile::getInstance($model3, 'nombre_img');
				$model3->ubicacion_img=$model3->nombre_img;
				//$model3->ubicacion_img=$ruta_de_guardado.{$fecha}_{$model3->nombre_img};
				//$model3->ubicacion_img="{$fecha}_{$model3->nombre_img}";
				//$idInicioEjecucion/$idAvances/
