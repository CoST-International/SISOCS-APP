...
class TipocontratoController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Tipocontrato']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->contrato));
		}
	...
	{
		$records=Tipocontrato::model()->findAll();
	 ...
	 * @param Tipocontrato $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tipocontrato-form')
		{
