...
class ProgramaFuenteController extends Controller
{
	/**
	 ...
	 */
	 public function actionAddnew() {
                $model=new ProgramaFuente;
        // Ajax Validation enabled
        $this->performAjaxValidation($model);
        // Flag to know if we will render the form or try to add 
        // new jon.
                $flag=true;
        if(isset($_POST['ProgramaFuente']))
        {       $flag=false;
            $model->attributes=$_POST['ProgramaFuente'];
	...
	{
		$dataProvider=new CActiveDataProvider('ProgramaFuente');
	...
	{
		$model=new ProgramaFuente('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ProgramaFuente']))
			$model->attributes=$_GET['ProgramaFuente'];
	...
	{
		$model=ProgramaFuente::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='programa-fuente-form')
		{
        ...
        public function actionBatchUpdate()
          {
            $items=new ProgramaFuente();
            //$model->unsetAttributes(); 
            // retrieve items to be updated in a batch mode
            // assuming each item is of model class ’Item’
            $items=  ProgramaFuente::model()->findAll();
            if (isset($_POST['item']))
            {$valid=true;
