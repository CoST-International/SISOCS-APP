...
class ProyectoController extends Controller
{
      ...
      public function actionViewDet()
	{
        ...
        public function ViewDetFuente()
        {
            
        }
    
    public function ViewDetBeneficiario($id)
	{
            $mf= ProyectoBeneficiario::model()->findAll('idproyecto=:en',array(':en'=>$id));
            //$mf=(count($mf)>0)?$mf:$mf->attributeLabels();
            $list=CHtml::listData($mf,'idproyecto','idproyecto');
            $f=new ProyectoBeneficiario;
            $a=$f->attributeLabels();
