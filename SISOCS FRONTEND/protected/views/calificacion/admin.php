        ...
        <tbody>
			...
			<?php
                ...
                <tr>
					...
					<td>
						<?php echo !empty($records->idMetodo0->siglas)?$records->idMetodo0->siglas:"No específicado"; ?>
					</td>
                    <td style="text-align:center">
                        <div class="row_buttons">
                            
                            <a class="btn btn-primary" style="padding:5px;border-radius:2px;margin-right:5px;border: #fff solid 1px;" href="<?php echo  Yii::app()->baseUrl."/index.php?r=calificacion/view&id=".$records->idCalificacion; ?>" style="color:#fff"><i class="fa fa-eye" aria-hidden="true" style="padding:4px;"></i></a>
                        
                            <a class="btn btn-warning" style="padding:5px;border-radius:2px;margin-right:5px;border: #fff solid 1px;" href="<?php echo  Yii::app()->baseUrl."/index.php?r=calificacion/update&id=".$records->idCalificacion; ?>" style="color:#fff"><i class="fa fa-edit" aria-hidden="true" style="padding:4px;"></i></a>

                            <button class="btn btn-danger" type="button" onClick="<?php $str=Yii::app()->baseUrl;
                      			  echo "deleteCalificacion(".$records->idCalificacion.")" ?>" style="padding:5px;border-radius:2px;margin-right:5px;border: #fff solid 1px;">
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            deleteCalificacion = function (id) {
                const url ="<?php echo Yii::app()->baseUrl?>/index.php?r=calificacion/delete&id="+id;
