<table class="display hover row-border" id="tabla_oferentes" cellspacing="0" style="width:100%;">
                ...
                <tr>
                    ...
                    <td>
                        <div class="row_buttons">
                            ...
                            <button class="btn btn-danger" type="button" onClick="<?php $str=Yii::app()->baseUrl; echo "deleteObject(".$datos[$row] ['idCalificacion'].",".$datos[$row] ['idOferente'].")" ?>" style="padding:5px;border-radius:2px;margin-right:5px;border: #fff solid 1px;">
    ...
    <script type="text/javascript">
        ...
        deleteObject = function (idCalificacion,id) {
