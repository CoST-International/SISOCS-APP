...
while ($row< $total_x){?>
	<tr>
		...
		<td><?php echo CHtml::link(CHtml::Button('Detalle'), array('PreFichaTecnicaM', 'id'=>$Proyecto[$row]['idProyecto'])); ?></td>
	         <?php $td_style = true; } 
                 else { ?>
                <td id="styled_td"><?php echo $Proyecto[$row] ['proyecto_codigo'];?></td>
		<td id="styled_td"><?php echo $Proyecto[$row] ['proyecto_nombre'];?></td>
		<td id="styled_td"><?php echo CHtml::link(CHtml::Button('Detalle'), array('PreFichaTecnicaM', 'id'=>$Proyecto[$row]['idProyecto'])); ?></td>
                <?php $td_style = false;
               }?>
        </tr>
