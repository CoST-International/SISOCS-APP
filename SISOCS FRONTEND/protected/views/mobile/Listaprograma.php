...
while ($row< $total_x){?>
	<tr>
		...
		<td><?php echo CHtml::link(CHtml::Button('Detalle'), array('FichaTecnica', 'control'=>'Programa', 'id'=>$Programas[$row]['idPrograma'])); ?></td>	
	         <?php $td_style = true; }
                 else { ?>
                <td id="styled_td"><?php echo $Programas[$row] ['programa_codigo'];?></td>
		<td id="styled_td"><?php echo $Programas[$row] ['programa_nombre'];?></td>					
		<td id="styled_td"><?php echo CHtml::link(CHtml::Button('Detalle'), array('FichaTecnica', 'control'=>'Programa', 'id'=>$Programas[$row]['idPrograma'])); ?></td>	
                 <?php $td_style = false;
               }?>   
        </tr>
