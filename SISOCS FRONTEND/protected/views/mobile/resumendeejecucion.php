...
from cs_calificacion ca,cs_contratacion c,cs_contratos co,cs_adjudicacion a
where ca.idProyecto = $IdProyecto and ca.tipocontrato  like 'Cons%' and ca.idCalificacion = a.idCalificacion
and a.idAdjudicacion = c.idAdjudicacion and c.idContratacion = co.idContratacion
 order by co.fechatercontra desc limit 1;";
...
<table class="tg">
    <tr>
        <td width="100%" valign="center" class="tg-031e"  style="text-align:center;">
        <div style="font-size:10px" class="tg-031e"><strong>Municipios beneficiados</strong></div>
  ...
  <tr>
    <td class="tg-031e" align="center" style="text-align:center" colspan="3">
         <div style="font-size:10px" class="tg-031e"><strong>Fuentes</strong></div>
      <?php
			/*include('config.php');*/
...
<table  class="tg">
 <tr>
     <td width="100%" class="tg-031e"  style="text-align:center;font-size:8px; " >
       <?php
			/*include('config.php');*/
...
<table  class="tg"  >
<tr>
    <td><div style="margin-left:25px;margin-right:25px;" id="map_canvas"></div></td>
 </tr>
</table>
</div-->
...
<td class="tg-031e"  colspan="3"></td>    
 ...
 <!--div class="slideshow" 
    ...
    <?php
    $result = mysql_query("select * from v_proyectos_carrousel where idProyecto = ".$IdProyecto." Limit 3");
