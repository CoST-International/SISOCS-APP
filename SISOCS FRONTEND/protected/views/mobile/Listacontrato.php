...
while ($row< $total_x){?>
        ...
        <?php if ($td_style == false){ ?>
            ...
            <td><?php echo CHtml::link(CHtml::Button('Detalle'), array('FichaTecnica', 'control'=>'Contratacion', 'id'=>$Contratos[$row] ['idContratacion'])); ?></td>      
           <?php $td_style = true; }
           else { ?>
            ...
            <td id="styled_td"><?php echo CHtml::link(CHtml::Button('Detalle'), array('FichaTecnica', 'control'=>'Contratacion', 'id'=>$Contratos[$row] ['idContratacion'])); ?></td>
           <?php $td_style = false;
               }?>
        </tr>
