...
while ($row< $total_x){?>
	<tr>
        <?php if ($td_style == false){ ?>
            ...
            <td><?php echo CHtml::link(CHtml::Button('Detalle'), array('FichaTecnica', 'control'=>'Adjudicacion', 'id'=>$Adjudicacion[$row] ['idAdjudicacion'])); ?></td>
            <?php $td_style = true; }
        else { ?>
            ...
            <td id="styled_td"><?php echo CHtml::link(CHtml::Button('Detalle'), array('FichaTecnica', 'control'=>'Adjudicacion', 'id'=>$Adjudicacion[$row] ['idAdjudicacion'])); ?></td>
            <?php $td_style = false;
        }?>   
	</tr>
