<table class="display hover row-border" id="tabla_forecastObs" cellspacing="0" style="width:100%;">
    <thead>
    ...
    <tbody>
        <?php
            ...
            <tr>
				...
				<td>
                    <span>
                    <?php echo $datos[$row] ['forecast_id']; ?>
                    </span>
                </td>
                <td>
                    <span>
                    <?php echo $datos[$row] ['obs_notes']; ?>
                    </span>
                </td>
				<td>
                    <span>
                    <?php echo $datos[$row] ['obs_amount']; ?>
                    </span>
                </td>
                <td>
                    <div class="row_buttons">
                        ...
                        <?php
                            echo "get_data_update('forecastObs',".$datos[$row]['id'].");"
                        ?>"
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var table = $('#tabla_forecastObs').DataTable({
            "language": {
        ...
        $('#tabla_forecastObs tbody').on('click', 'tr', function () {
	...
	deleteObject = function (id) {
		...
		var controller='<?php echo CController::createUrl("ForecastObservations/delete"); ?>';
