...
define("EW_PROJECT_NAME", "revision", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{95DDD5E1-EED3-4F75-9459-65662A38CD3B}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'dasr2V6t2zBfwnyZ', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/revision.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "passpass", "db" => "soptravidb2", "qs" => "`", "qe" => "`");
...
define("EW_USER_TABLE", "`cruge_user`", TRUE);
...
// File upload
define("EW_UPLOAD_DEST_PATH", "tmp/", TRUE); // Upload destination path (relative to app root)
