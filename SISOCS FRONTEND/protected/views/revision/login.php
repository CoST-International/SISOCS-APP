...
class clogin extends ccruge_user {
	...
	function __construct() {
		...
		if (!isset($GLOBALS["cruge_user"]) || get_class($GLOBALS["cruge_user"]) == "ccruge_user") {
			$GLOBALS["cruge_user"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["cruge_user"];
		}
		if (!isset($GLOBALS["cruge_user"])) $GLOBALS["cruge_user"] = &$this;
