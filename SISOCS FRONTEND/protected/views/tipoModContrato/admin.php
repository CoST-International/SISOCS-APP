...
$('.search-form form').submit(function(){
	$('#tipo-mod-contrato-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Gestionar Tipo Mod Contratos</h1>
...
$this->widget('zii.widgets.grid.CGridView', array(
        ...
        'columns' => array(
				array('header' => 'idTipoModificacion',
					  'name'   => 'idTipoModificacion'),
				array('header' => 'tipo_modificacion',
