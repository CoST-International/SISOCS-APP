...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group  ">
		...
		<?php echo  $form->dropDownList($model,'documentType',$model->listarDocumentType(),array('prompt'=>'--Seleccione un Valor--','class'=>'form-control')); ?>
	...
	<div class="form-group   buttons">
		<?php //echo CHtml::submitButton($model->isNewRecord ? 'Crear' : 'Save'); ?>
			...
			<?php if ($model->isNewRecord==false) {
			     ...
			     echo CHtml::Button('Guardar',array('id'=>'enviar','onclick'=>'update_documents(\'documents\','.$model->id.');'));
				 echo CHtml::button('Cerrar', array('onclick' => 'dialogoDeUpdate.dialog("close"); return false;'));
			}else{
			      echo CHtml::Button('Guardar',array('id'=>'enviar','onclick'=>'send_documents(\'documents\');'));
		    }
