                ...
                <tr>
                    ...
                    <td>
                        <div class="row_buttons">
                            ...
                            <?php
                              echo "get_data_update('documentos',".$datos[$row]['id'].");"
                            ?>"
                            ><i class="fa fa-edit" aria-hidden="true" style="padding:4px;"></i></div>

                            <button class="btn btn-danger" type="button" onClick="<?php $str=Yii::app()->baseUrl; echo "deleteObject('documentos',".$datos[$row] ['id'].")" ?>" style="padding:5px;border-radius:2px;margin-right:5px;border: #fff solid 1px;">
