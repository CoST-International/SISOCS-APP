...
while ($row< $total_x){?>
	<tr>
		...
		<td><?php echo CHtml::link(CHtml::encode($Calificacion[$row] ['idCalificacion']), array('Calificacion/view', 'id'=>$Calificacion[$row] ['idCalificacion'])); ?></td>
		<td><?php echo $Calificacion[$row] ['numproceso'];?></td>
		<td><?php echo $Calificacion[$row] ['nomprocesoproyecto'];?></td>
		<td><?php echo $Calificacion[$row] ['idFuncionario'];?></td>
		<td><?php echo $Calificacion[$row] ['nombre'];?></td>
		<td><?php echo $Calificacion[$row] ['adquisicion'];?></td>
		<td><?php echo CHtml::link(CHtml::Button('Ver información detallada'), array('fichatecnicapro', 'idpro'=>$Calificacion[$row] ['idProyecto'])); ?></td>	
	        <?php $td_style = true; }
                 else { ?>
                <td id="styled_td"><?php echo CHtml::link(CHtml::encode($Calificacion[$row] ['idCalificacion']), array('Calificacion/view', 'id'=>$Calificacion[$row] ['idCalificacion'])); ?></td>
		<td id="styled_td"><?php echo $Calificacion[$row] ['numproceso'];?></td>
		<td id="styled_td"><?php echo $Calificacion[$row] ['nomprocesoproyecto'];?></td>
		<td id="styled_td"><?php echo $Calificacion[$row] ['idFuncionario'];?></td>
		<td id="styled_td"><?php echo $Calificacion[$row] ['nombre'];?></td>
		<td id="styled_td"><?php echo $Calificacion[$row] ['adquisicion'];?></td>
		<td id="styled_td"><?php echo CHtml::link(CHtml::Button('Ver información detallada'), array('fichatecnicapro', 'idpro'=>$Calificacion[$row] ['idProyecto'])); ?></td>	
	         <?php $td_style = false;
               }?>  
        </tr>
<?php $row++;}?>		
