...
$this->menu=array(
	//array('label'=>'Listar Gestión Contratos', 'url'=>array('index')),
	array('label'=>'Crear Gestión Contratos', 'url'=>array('create')),
);
...
$('.search-form form').submit(function(){
	$('#estadosgestcontra-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Gestionar Estadosgestcontras</h1>
