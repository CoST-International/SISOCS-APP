...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group ">
		...
		<?php echo $form->hiddenField($model,'idAdjudicacion',array('value'=>$idAdjudicacion)); ?>
	...
	<div class="form-group ">
		...
		<?php echo $form->textField($model,'datePublished',array('size'=>20,'maxlength'=>20,'placeholder'=>'AAAA/MM/DD','readonly'=>false ));?>
		<?php echo $form->error($model,'datePublished'); ?>
	</div>

	<div class="form-group ">
		<?php echo $form->labelEx($model,'dateModified'); ?><br>
		<?php echo $form->textField($model,'dateModified',array('size'=>20,'maxlength'=>20,'placeholder'=>'AAAA/MM/DD','readonly'=>false ));?>
	...
	<div class="form-group  buttons">
		<?php //echo CHtml::submitButton($model->isNewRecord ? 'Crear' : 'Save'); ?>
            <?php  //echo CHtml::Button('Guardar',array('id'=>'enviar','onclick'=>'send_desembolsos(); updateDialog.dialog("close"); return false;'));  ?>
