...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		...
		<?php echo  $form->dropDownList($model,'idProyecto',Yii::app()->controller->listaProyectos(),array('prompt'=>'--Seleccione un valor--','class'=>'form-control')); ?>
	...
	<div class="form-group buttons">
		<?php //echo CHtml::submitButton($model->isNewRecord ? 'Crear' : 'Save'); ?>
			...
			<?php if ($model->isNewRecord==false) {
			     ...
			     echo CHtml::Button('Guardar',array('id'=>'enviar','onclick'=>'update_documents(\'relatedProcess\','.$model->id.');','class'=>'btn btn-success'));
				 echo CHtml::button('Cerrar', array('onclick' => 'dialogoDeUpdate.dialog("close"); return false;','class'=>'btn btn-info'));
			}else{
			      echo CHtml::Button('Guardar',array('id'=>'enviar','onclick'=>'send_documents(\'relatedProcess\');','class'=>'btn btn-success'));
		    }
