...
return array(
    ...
    'import' => array(
        ...
        //'application.extensions.analytics.*',
    ) ,
...
'coreCss'=>false,
        ...
        */
        ...
        'db' => array(
           ...
           /* 'connectionString' => 'mysql:host=67.207.88.38;dbname=sisocs_insep_desarrollo',
            'emulatePrepare' => true,
            'username' => 'dmvp',
            'password' => '9mUp173!',
            'charset' => 'utf8',
    ...
    'params'=>array(
		...
		'AttPath' => 'webroot.adjuntos',
		'countryCode' => 'HND',
		'ORG_ID' => 'insep',
        'adminEmail'=>'webmaster@example.com',
        'OCDS_Prefix' => 'ocds-mfx54g',
        'NODE_URL' => 'http://67.207.88.38:8080/',
