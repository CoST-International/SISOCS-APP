 ...
 *
 * The followings are the available columns in table '{{metodo}}':
 ...
 */
class Metodo extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('idMetodo, adquisicion, siglas', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'calificacions' => array(self::HAS_MANY, 'Calificacion', 'idMetodo'),
		);
	}
...
',
	 ...
	 * @return Metodo the static model class
	 */
