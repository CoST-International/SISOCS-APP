...
/**
 * This is the model class for table "{{contracts_signatories}}".
 *
 * The followings are the available columns in table '{{contracts_signatories}}':
 * @property integer $id
 ...
 */
class ContractsSignatories extends CActiveRecord
{
	/**
	 ...
	 * @return ContractsSignatories the static model class
	 */
