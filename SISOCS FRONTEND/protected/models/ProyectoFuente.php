 ...
 * @property integer $id
 */
class ProyectoFuente extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('idProyecto', 'length', 'max'=>20),
			...
			array('idProyecto, idFuente, monto, idMoneda, tasa_cambio', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('idProyecto',$this->programa,true);
	...
	public static function model($className=__CLASS__)
	{
        ...
        {
            return array('idProyecto','idFuente');
        ...
        {
            $dat= Currency::model()->findAll();
            $list = CHtml::listData($dat,'id', 'moneda');
            return $list ;
        }
          public function listaParties()
        {
            $dat= Parties::model()->findAll();
