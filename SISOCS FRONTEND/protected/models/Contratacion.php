<?php
    ...
    */
    class Contratacion extends CActiveRecord
    {
        ...
        */
        public function rules()
        {
            ...
            return array(
			array('fecha_creacion, fechainicio, fechafinal', 'required'),
			...
			array('titulocontrato', 'length', 'max'=>2000),
			array('estado', 'length', 'max'=>25),
            array('primario','boolean'),
    ...
    array('primario,image1, image2, image3, image4, idContratacion, idAdjudicacion, idEntidad,  precioLPS, precioUSD, alcances, fechainicio, fechafinal, duracioncontrato, documentocontra, regante, espeplanos, estado, otro, ncontrato, titulocontrato, fecha_publicacion, fecha_creacion', 'safe', 'on'=>'search,published'/*, 'on'=>'insert', 'on'=>'update'*/),
            );
        }
        ...
        */
        public function search()
        {
            ...
            return new CActiveDataProvider($this, array(
                'criteria'=>$criteria,
                'sort'=>array(
                  'defaultOrder'=>'t.idContratacion DESC',
                ),
            ));
        }
    ...
    public function listaEstados() {
      ...
      return $list;
		...
		public function listaAdjudicacionID($idCreate)
        {
		...
		public function listaContratosID($idContratacion){
		$dat = Contratos::model()->findAll('idContratacion=\''.$idContratacion.'\'');

				 $list = array();

            foreach ($dat as $row) {
            	$list[$row->idContratos] = '('.substr(str_pad($row->idContratos,10,' ',STR_PAD_LEFT),0,10).') Modificación #'.$row->nmodifica;
            }
