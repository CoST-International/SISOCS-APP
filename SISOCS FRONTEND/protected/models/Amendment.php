 ...
 * @property string $amendsReleaseID
 *
...
class Amendment extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('idContratacion, date, description', 'required'),
			array('idContratacion', 'numerical', 'integerOnly'=>true),
			array('rationale, description, amendsReleaseID', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, idContratacion, date, rationale, description, amendsReleaseID', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'amendsReleaseID' => 'Id Liberación Compresación',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('amendsReleaseID',$this->amendsReleaseID,true);
