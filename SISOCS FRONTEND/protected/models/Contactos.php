...
class Contactos extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('idContacto', 'numerical', 'integerOnly'=>true),
			array('Nombres, direccion, email', 'length', 'max'=>50),
			array('telefono, movil', 'length', 'max'=>10),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idContacto, Nombres, direccion, telefono, movil, email', 'safe', 'on'=>'search'),
		);
	}
