...
/**
 * This is the model class for table "{{planning_documents}}".
 *
 * The followings are the available columns in table '{{planning_documents}}':
 * @property integer $id
 ...
 */
class PlanningDocuments extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('idProyecto, documentType, title, url', 'required'),
			array('idProyecto, pageStart, pageEnd', 'numerical', 'integerOnly'=>true),
			...
			array('uploadDocument, id, idProyecto, documentType, title, description, url, pageStart, pageEnd, datePublished, dateModified, accessDetails', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return PlanningDocuments the static model class
	 */
