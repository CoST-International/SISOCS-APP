 ...
 */
class GestionFinales extends CActiveRecord

{
    ...
    function rules()
    {
        ...
        return array(
            ...
            array(
                'titulo_contrato, idInicioEjecucion, idFinalizacion, idContratacion, fecha_inicio',
                'safe',
    ...
    public function published()
    {
        ...
        $criteria->condition = "idInicioEjecucion IN (SELECT DISTINCT(idInicioEjecucion) FROM cs_final_ejecucion WHERE estado = 'PUBLICADO')";
        $criteria->together = true;
        $criteria->compare('idContratacion0.titulocontrato', $this->titulo_contrato, true); // related field new
        $criteria->compare('idInicioEjecucion', $this->idInicioEjecucion,true);
        $criteria->compare('idContratacion', $this->idContratacion,true);
