...
/**
 * This is the model class for table "{{finalizacion_documents}}".
 *
 * The followings are the available columns in table '{{finalizacion_documents}}':
 * @property integer $id
 ...
 */
class FinalizacionDocuments extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('idFinalizacion, documentType, title, url', 'required'),
			array('idFinalizacion, pageStart, pageEnd', 'numerical', 'integerOnly'=>true),
			...
			array('id, idFinalizacion, documentType, title, description, url, pageStart, pageEnd, datePublished, dateModified, accessDetails', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return FinalizacionDocuments the static model class
	 */
