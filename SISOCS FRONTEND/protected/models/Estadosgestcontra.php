 ...
 * @property integer $idEstadoGesion
...
class Estadosgestcontra extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('idEstadoGesion', 'numerical', 'integerOnly'=>true),
			array('estado', 'length', 'max'=>1),
			array('descripcion', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idEstadoGesion, estado, descripcion', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		return array(
			'idEstadoGesion' => 'Id Estado Gesion',
			'estado' => 'Estado',
	...
	public function search()
	{
		...
		$criteria->compare('idEstadoGesion',$this->idEstadoGesion);
