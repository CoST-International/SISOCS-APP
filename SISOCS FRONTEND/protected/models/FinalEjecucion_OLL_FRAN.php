...
class FinalEjecucion extends CActiveRecord
{
    ...
    $criteria=new CDbCriteria;
		...
		return new CActiveDataProvider($this,
			...
			'sort'=>array('defaultOrder'=>'t.idFinalizacion DESC',),
		));
	}
